...
void cq_lua_check_int_list(lua_State *s, int32_t i, cq_i64_list_out p) {call(_h.check_int_list, s, i, p);}
...
int32_t cq_lua_return_int_list(lua_State *s, cq_i64_list_in i) {call(_h.push_int_list, s, i); return 1;}
