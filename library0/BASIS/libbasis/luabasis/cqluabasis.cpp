...
int32_t cq_lua_return_int64s (lua_State *s, cq_int64s_send  f, cq_int64s  *v) {call(_h.push_integers, s, f, v); return 1;}
int32_t cq_lua_return_strings(lua_State *s, cq_strings_send f, cq_strings *v) {call(_h.push_strings , s, f, v); return 1;}
int32_t cq_lua_return_ss_map (lua_State *s, cq_ss_map_send  f, cq_ss_map  *v) {call(_h.push_ss_table, s, f, v); return 1;}
