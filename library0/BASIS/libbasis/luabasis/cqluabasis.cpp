...
cq_object  *cq_lua_check_object(lua_State *s, int32_t i) {return          call(_h.check_object  , s, i);}

void cq_lua_check_int64_list(lua_State *s, int32_t i, cq_int64_list *p) {call(_h.check_int64_list, s, i, p);}
void cq_lua_check_str_list  (lua_State *s, int32_t i, cq_str_list   *p) {call(_h.check_str_list  , s, i, p);}
void cq_lua_check_ss_map    (lua_State *s, int32_t i, cq_ss_map     *p) {call(_h.check_ss_map    , s, i, p);}
...
int32_t cq_lua_return_object(lua_State *s, cq_object  *v) {call(_h.push_object , s, v); return 1;}

int32_t cq_lua_return_int64_list(lua_State *s, cq_int64_list *i) {call(_h.push_int64_list, s, i); return 1;}
int32_t cq_lua_return_str_list  (lua_State *s, cq_str_list   *i) {call(_h.push_str_list  , s, i); return 1;}
int32_t cq_lua_return_ss_map    (lua_State *s, cq_ss_map     *i) {call(_h.push_ss_map    , s, i); return 1;}
