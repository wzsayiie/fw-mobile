...
CQ_C_LINK struct cq_int64s  *cq_lua_check_int64s (struct lua_State *state, int32_t index);
CQ_C_LINK struct cq_strings *cq_lua_check_strings(struct lua_State *state, int32_t index);
CQ_C_LINK struct cq_ss_map  *cq_lua_check_ss_map (struct lua_State *state, int32_t index);
...
CQ_C_LINK int32_t cq_lua_return_int64s (struct lua_State *s, cq_int64s_send  f, struct cq_int64s  *v);
CQ_C_LINK int32_t cq_lua_return_strings(struct lua_State *s, cq_strings_send f, struct cq_strings *v);
CQ_C_LINK int32_t cq_lua_return_ss_map (struct lua_State *s, cq_ss_map_send  f, struct cq_ss_map  *v);
...
struct _cq_lua_handlers {
    ...
    struct cq_int64s  *(*check_integers)(struct lua_State *state, int32_t index);
    struct cq_strings *(*check_strings )(struct lua_State *state, int32_t index);
    struct cq_ss_map  *(*check_ss_table)(struct lua_State *state, int32_t index);
    ...
    void (*push_integers)(struct lua_State *s, cq_int64s_send  f, struct cq_int64s  *v);
    void (*push_strings )(struct lua_State *s, cq_strings_send f, struct cq_strings *v);
    void (*push_ss_table)(struct lua_State *s, cq_ss_map_send  f, struct cq_ss_map  *v);
};
