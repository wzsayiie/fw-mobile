...
CQ_C_LINK cq_int64s  *cq_lua_check_int64s (struct lua_State *state, int32_t index);
CQ_C_LINK cq_strings *cq_lua_check_strings(struct lua_State *state, int32_t index);
CQ_C_LINK cq_ss_map  *cq_lua_check_ss_map (struct lua_State *state, int32_t index);
...
CQ_C_LINK int32_t cq_lua_return_int64s (struct lua_State *state, cq_int64s_sender  f, cq_int64s  *v);
CQ_C_LINK int32_t cq_lua_return_strings(struct lua_State *state, cq_strings_sender f, cq_strings *v);
CQ_C_LINK int32_t cq_lua_return_ss_map (struct lua_State *state, cq_ss_map_sender  f, cq_ss_map  *v);
...
struct _cq_lua_handlers {
    ...
    cq_int64s  *(*check_integers)(struct lua_State *state, int32_t index);
    cq_strings *(*check_strings )(struct lua_State *state, int32_t index);
    cq_ss_map  *(*check_ss_table)(struct lua_State *state, int32_t index);
    ...
    void (*push_integers)(struct lua_State *state, cq_int64s_sender  f, cq_int64s  *v);
    void (*push_strings )(struct lua_State *state, cq_strings_sender f, cq_strings *v);
    void (*push_ss_table)(struct lua_State *state, cq_ss_map_sender  f, cq_ss_map  *v);
};
